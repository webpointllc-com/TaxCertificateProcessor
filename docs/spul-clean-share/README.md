# S-PUL clean-share pack

Documents for making S-PUL teammate-ready (Adam) without the `kata_deploy` / beta demo mess.
...
**Canonical:** `spul/` in this repo. **Archive:** live `webpoint-spul-beta` demo UI/pipeline. **Highlighter:** untouched.
